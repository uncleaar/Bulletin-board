...
@WebAppConfiguration
@ActiveProfiles("test")
public class LocalityRestControllerValidationTest {
    ...
    public void findById_idIsNotPositive_invalidRq() throws Exception {
        ...
        mockMvc.perform(get(ENDPOINT + entityId))
                ...
                .andExpect(jsonPath("$.localityList", nullValue()))
    ...
    @Test
    public void update_regionIdIsNull_invalidRq() throws Exception {
        final boolean updated = false;
        final String errorMessage = "The regionId is null.";
    ...
    @Test
    public void update_regionIdIsNotPositive_invalidRq() throws Exception {
        final boolean updated = false;
        final String errorMessage = "The regionId is not positive.";
